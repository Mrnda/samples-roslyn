...
namespace RoslynSamples.BasicRefactoring
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(RoslynSamplesBasicRefactoringCodeRefactoringProvider)), Shared]
    internal class RoslynSamplesBasicRefactoringCodeRefactoringProvider : CodeRefactoringProvider
    {
